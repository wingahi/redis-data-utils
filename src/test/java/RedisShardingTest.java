 ...
 */
public class RedisShardingTest {
    ...
    public static void main(String[] args) {
        ...
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("redisSharding.xml");
        ...
        for (int i = 1; i <= num; i++) {
            // 存数据  
            redisUtils.set(key+i, "yingjun"+i);  
